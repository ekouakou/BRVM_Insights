...
--
-- Hôte : localhost:3306
-- Généré le : lun. 03 août 2026 à 19:29
...
CREATE TABLE `combined_analyses` (
  ...
  `report_ids` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`report_ids`)),
  `bulletin_ids` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`bulletin_ids`)),
  `provider` varchar(30) NOT NULL,
  `model` varchar(50) NOT NULL,
  `computed_date` date NOT NULL COMMENT 'date du calcul — cache "une fois par jour"',
  `summary` text DEFAULT NULL,
  `details` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'analyse combinée complète + chart_data' CHECK (json_valid(`details`)),
...
CREATE TABLE `companies` (
  `id` int(11) NOT NULL,
  `symbol` varchar(10) NOT NULL COMMENT 'Symbole boursier',
  `name` varchar(255) NOT NULL,
  `full_name` varchar(255) DEFAULT NULL,
  `sector_id` int(11) DEFAULT NULL,
  `country_id` int(11) DEFAULT NULL,
  `isin_code` varchar(12) DEFAULT NULL COMMENT 'Code ISIN international',
  ...
  `brvm_report_slug` varchar(150) DEFAULT NULL COMMENT 'Slug de /fr/rapports-societe-cotes/{slug} sur brvm.org',
...
(1, 'ABJC', 'SERVAIR ABIDJAN COTE D\'IVOIRE', 'SERVAIR ABIDJAN COTE D\'IVOIRE', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'servair-abidjan-ci', 1, '2026-08-03 01:06:54', '2026-08-03 02:56:29'),
(2, 'BICB', 'BANQUE INTERNATIONALE POUR L’INDUSTRIE ET LE COMMERCE DU BENIN', 'BANQUE INTERNATIONALE POUR L’INDUSTRIE ET LE COMMERCE DU BENIN', NULL, 4, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-08-03 01:06:54', '2026-08-03 01:06:54'),
(3, 'BICC', 'BICI COTE D\'IVOIRE', 'BICI COTE D\'IVOIRE', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'bici-ci', 1, '2026-08-03 01:06:54', '2026-08-03 02:56:29'),
(4, 'BNBC', 'BERNABE COTE D\'IVOIRE', 'BERNABE COTE D\'IVOIRE', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'bernabe-ci', 1, '2026-08-03 01:06:54', '2026-08-03 02:56:29'),
(5, 'BOAB', 'BANK OF AFRICA BENIN', 'BANK OF AFRICA BENIN', NULL, 4, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'bank-africa-bn', 1, '2026-08-03 01:06:54', '2026-08-03 02:56:29'),
(6, 'BOABF', 'BANK OF AFRICA BURKINA FASO', 'BANK OF AFRICA BURKINA FASO', NULL, 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'bank-africa-bf', 1, '2026-08-03 01:06:54', '2026-08-03 02:56:29'),
(7, 'BOAC', 'BANK OF AFRICA COTE D\'IVOIRE', 'BANK OF AFRICA COTE D\'IVOIRE', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'bank-africa-ci', 1, '2026-08-03 01:06:54', '2026-08-03 02:56:29'),
(8, 'BOAM', 'BANK OF AFRICA MALI', 'BANK OF AFRICA MALI', NULL, 7, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'bank-africa-ml', 1, '2026-08-03 01:06:54', '2026-08-03 02:56:29'),
(9, 'BOAN', 'BANK OF AFRICA NIGER', 'BANK OF AFRICA NIGER', NULL, 6, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'bank-africa-ng', 1, '2026-08-03 01:06:54', '2026-08-03 02:56:29'),
(10, 'BOAS', 'BANK OF AFRICA SENEGAL', 'BANK OF AFRICA SENEGAL', NULL, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'bank-africa-sn', 1, '2026-08-03 01:06:54', '2026-08-03 02:56:29'),
(11, 'CABC', 'SICABLE COTE D\'IVOIRE', 'SICABLE COTE D\'IVOIRE', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'sicable', 1, '2026-08-03 01:06:54', '2026-08-03 02:56:29'),
(12, 'CBIBF', 'CORIS BANK INTERNATIONAL BURKINA FASO', 'CORIS BANK INTERNATIONAL BURKINA FASO', NULL, 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'coris-bank-international', 1, '2026-08-03 01:06:54', '2026-08-03 02:56:29'),
(13, 'CFAC', 'CFAO MOTORS COTE D\'IVOIRE', 'CFAO MOTORS COTE D\'IVOIRE', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'cfao-motors-ci', 1, '2026-08-03 01:06:54', '2026-08-03 02:56:29'),
(14, 'CIEC', 'CIE COTE D\'IVOIRE', 'CIE COTE D\'IVOIRE', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'cie-ci', 1, '2026-08-03 01:06:54', '2026-08-03 02:56:29'),
(15, 'ECOC', 'ECOBANK COTE D\'IVOIRE', 'ECOBANK COTE D\'IVOIRE', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'ecobank-ci', 1, '2026-08-03 01:06:54', '2026-08-03 02:56:29'),
(16, 'ETIT', 'Ecobank Transnational Incorporated TOGO', 'Ecobank Transnational Incorporated TOGO', NULL, 5, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-08-03 01:06:54', '2026-08-03 01:06:54'),
(17, 'FTSC', 'FILTISAC COTE D\'IVOIRE', 'FILTISAC COTE D\'IVOIRE', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'filtisac-ci', 1, '2026-08-03 01:06:55', '2026-08-03 02:56:29'),
(18, 'LNBB', 'LOTERIE NATIONALE DU BENIN', 'LOTERIE NATIONALE DU BENIN', NULL, 4, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-08-03 01:06:55', '2026-08-03 01:06:55'),
(19, 'NEIC', 'NEI-CEDA COTE D\'IVOIRE', 'NEI-CEDA COTE D\'IVOIRE', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'nei-ceda-ci', 1, '2026-08-03 01:06:55', '2026-08-03 02:56:29'),
(20, 'NSBC', 'NSIA BANQUE COTE D\'IVOIRE', 'NSIA BANQUE COTE D\'IVOIRE', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-08-03 01:06:55', '2026-08-03 01:06:55'),
(21, 'NTLC', 'NESTLE COTE D\'IVOIRE', 'NESTLE COTE D\'IVOIRE', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'nestle-ci', 1, '2026-08-03 01:06:55', '2026-08-03 02:56:29'),
(22, 'ONTBF', 'ONATEL BURKINA FASO', 'ONATEL BURKINA FASO', NULL, 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-08-03 01:06:55', '2026-08-03 01:06:55'),
(23, 'ORAC', 'ORANGE COTE D\'IVOIRE', 'ORANGE COTE D\'IVOIRE', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'orange-ci', 1, '2026-08-03 01:06:55', '2026-08-03 02:56:29'),
(24, 'ORGT', 'ORAGROUP TOGO', 'ORAGROUP TOGO', NULL, 5, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'oragroup', 1, '2026-08-03 01:06:55', '2026-08-03 02:56:29'),
(25, 'PALC', 'PALM COTE D\'IVOIRE', 'PALM COTE D\'IVOIRE', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'palm-ci', 1, '2026-08-03 01:06:55', '2026-08-03 02:56:29'),
(26, 'PRSC', 'TRACTAFRIC MOTORS COTE D\'IVOIRE', 'TRACTAFRIC MOTORS COTE D\'IVOIRE', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-08-03 01:06:55', '2026-08-03 01:06:55'),
(27, 'SAFC', 'SAFCA COTE D\'IVOIRE', 'SAFCA COTE D\'IVOIRE', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'safca-ci', 1, '2026-08-03 01:06:55', '2026-08-03 02:56:29'),
(28, 'SCRC', 'SUCRIVOIRE COTE D\'IVOIRE', 'SUCRIVOIRE COTE D\'IVOIRE', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'sucrivoire', 1, '2026-08-03 01:06:55', '2026-08-03 02:56:29'),
(29, 'SDCC', 'SODE COTE D\'IVOIRE', 'SODE COTE D\'IVOIRE', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-08-03 01:06:55', '2026-08-03 01:06:55'),
(30, 'SDSC', 'AFRICA GLOBAL LOGISTICS COTE D\'IVOIRE', 'AFRICA GLOBAL LOGISTICS COTE D\'IVOIRE', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-08-03 01:06:55', '2026-08-03 01:06:55'),
(31, 'SEMC', 'EVIOSYS PACKAGING SIEM COTE D\'IVOIRE', 'EVIOSYS PACKAGING SIEM COTE D\'IVOIRE', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-08-03 01:06:55', '2026-08-03 01:06:55'),
(32, 'SGBC', 'SOCIETE GENERALE COTE D\'IVOIRE', 'SOCIETE GENERALE COTE D\'IVOIRE', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-08-03 01:06:55', '2026-08-03 01:06:55'),
(33, 'SHEC', 'VIVO ENERGY COTE D\'IVOIRE', 'VIVO ENERGY COTE D\'IVOIRE', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'vivo-energy-ci', 1, '2026-08-03 01:06:55', '2026-08-03 02:56:29'),
(34, 'SIBC', 'SOCIETE IVOIRIENNE DE BANQUE COTE D\'IVOIRE', 'SOCIETE IVOIRIENNE DE BANQUE COTE D\'IVOIRE', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-08-03 01:06:55', '2026-08-03 01:06:55'),
(35, 'SICC', 'SICOR COTE D\'IVOIRE', 'SICOR COTE D\'IVOIRE', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'sicor', 1, '2026-08-03 01:06:55', '2026-08-03 02:56:29'),
(36, 'SIVC', 'ERIUM COTE D’IVOIRE', 'ERIUM COTE D’IVOIRE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-08-03 01:06:55', '2026-08-03 01:06:55'),
(37, 'SLBC', 'SOLIBRA COTE D\'IVOIRE', 'SOLIBRA COTE D\'IVOIRE', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'solibra', 1, '2026-08-03 01:06:55', '2026-08-03 02:56:29'),
(38, 'SMBC', 'SMB COTE D\'IVOIRE', 'SMB COTE D\'IVOIRE', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'smb', 1, '2026-08-03 01:06:55', '2026-08-03 02:56:29'),
(39, 'SNTS', 'SONATEL SENEGAL', 'SONATEL SENEGAL', NULL, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-08-03 01:06:55', '2026-08-03 01:06:55'),
(40, 'SOGC', 'SOGB COTE D\'IVOIRE', 'SOGB COTE D\'IVOIRE', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'sogb', 1, '2026-08-03 01:06:55', '2026-08-03 02:56:29'),
(41, 'SPHC', 'SAPH COTE D\'IVOIRE', 'SAPH COTE D\'IVOIRE', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'saph-ci', 1, '2026-08-03 01:06:55', '2026-08-03 02:56:29'),
(42, 'STAC', 'SETAO COTE D\'IVOIRE', 'SETAO COTE D\'IVOIRE', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'setao-ci', 1, '2026-08-03 01:06:55', '2026-08-03 02:56:29'),
(43, 'STBC', 'SITAB COTE D\'IVOIRE', 'SITAB COTE D\'IVOIRE', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'sitab', 1, '2026-08-03 01:06:55', '2026-08-03 02:56:29'),
(44, 'TTLC', 'TOTALENERGIES MARKETING COTE D\'IVOIRE', 'TOTALENERGIES MARKETING COTE D\'IVOIRE', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-08-03 01:06:55', '2026-08-03 01:06:55'),
(45, 'TTLS', 'TOTALENERGIES MARKETING SENEGAL', 'TOTALENERGIES MARKETING SENEGAL', NULL, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-08-03 01:06:55', '2026-08-03 01:06:55'),
(46, 'UNLC', 'UNILEVER COTE D\'IVOIRE', 'UNILEVER COTE D\'IVOIRE', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'unilever-ci', 1, '2026-08-03 01:06:55', '2026-08-03 02:56:29'),
(47, 'UNXC', 'UNIWAX COTE D\'IVOIRE', 'UNIWAX COTE D\'IVOIRE', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'uniwax-ci', 1, '2026-08-03 01:06:55', '2026-08-03 02:56:29');
...
CREATE TABLE `company_reports` (
  ...
  `report_type` varchar(50) DEFAULT NULL COMMENT 'annuel, semestriel, trimestriel, etats_financiers, attestation_cac, autre',
  ...
  `local_path` varchar(500) DEFAULT NULL COMMENT 'Chemin local du PDF téléchargé',
  `file_size` bigint(20) DEFAULT NULL COMMENT 'Taille du fichier en octets',
  `file_hash` char(64) DEFAULT NULL COMMENT 'SHA-256 du contenu téléchargé (détection de doublons/changements)',
  `downloaded_at` timestamp NULL DEFAULT NULL,
  `text_extracted` tinyint(1) DEFAULT 0,
  `extraction_method` varchar(10) DEFAULT NULL COMMENT 'text (pdftotext) ou ocr (tesseract)',
...
CREATE TABLE `company_report_analyses` (
  ...
  `summary` text DEFAULT NULL COMMENT 'résumé exécutif court, pour affichage/listage rapide',
  `details` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'analyse complète structurée (financials, SWOT, risques, thèse, glossaire...)' CHECK (json_valid(`details`)),
  `status` varchar(20) NOT NULL DEFAULT 'success' COMMENT 'success|failed',
  `error_message` text DEFAULT NULL,
  `input_char_count` int(11) DEFAULT NULL,
  `raw_response` longtext DEFAULT NULL COMMENT 'réponse brute du fournisseur IA, pour audit/debug',
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `company_report_comparisons` (
  ...
  `company_ids` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT 'entreprises incluses dans la comparaison' CHECK (json_valid(`company_ids`)),
  `report_ids` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'rapports effectivement inclus, calculé à l’appel' CHECK (json_valid(`report_ids`)),
  ...
  `computed_date` date NOT NULL COMMENT 'date du calcul — cache "une fois par jour"',
  `summary` text DEFAULT NULL,
  `details` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'analyse comparative complète + chart_data' CHECK (json_valid(`details`)),
  `status` varchar(20) NOT NULL DEFAULT 'success',
  `error_message` text DEFAULT NULL,
  `input_char_count` int(11) DEFAULT NULL,
  `raw_response` longtext DEFAULT NULL,
...
CREATE TABLE `company_report_contents` (
  ...
  `formatted_markdown` longtext DEFAULT NULL COMMENT 'Texte brut restructuré en markdown (tableaux) par IA, voir class/ReportMarkdownFormatterService.php',
  `markdown_status` varchar(20) DEFAULT NULL COMMENT 'processing|success|failed',
  `markdown_error` text DEFAULT NULL,
  `markdown_provider` varchar(30) DEFAULT NULL,
  `markdown_model` varchar(50) DEFAULT NULL,
...
CREATE TABLE `countries` (
  `id` int(11) NOT NULL,
  `code` char(2) NOT NULL COMMENT 'Code ISO 2 lettres',
...
CREATE TABLE `market_bulletin_analyses` (
  ...
  `model` varchar(50) NOT NULL,
  `summary` text DEFAULT NULL COMMENT 'résumé de séance court, pour affichage/listage rapide',
  `details` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'analyse complète structurée (mouvements, secteurs, sentiment, glossaire...)' CHECK (json_valid(`details`)),
  `status` varchar(20) NOT NULL DEFAULT 'success' COMMENT 'success|failed',
  `error_message` text DEFAULT NULL,
  `input_char_count` int(11) DEFAULT NULL,
  `raw_response` longtext DEFAULT NULL COMMENT 'réponse brute du fournisseur IA, pour audit/debug',
...
CREATE TABLE `market_bulletin_contents` (
  `bulletin_id` bigint(20) NOT NULL,
  `extracted_text` longtext DEFAULT NULL,
  `formatted_markdown` longtext DEFAULT NULL COMMENT 'Texte brut restructuré en markdown (tableaux) par IA, voir class/BulletinMarkdownFormatterService.php',
  `markdown_status` varchar(20) DEFAULT NULL COMMENT 'processing|success|failed',
  `markdown_error` text DEFAULT NULL,
  `markdown_provider` varchar(30) DEFAULT NULL,
  `markdown_model` varchar(50) DEFAULT NULL,
...
CREATE TABLE `market_indices` (
  `id` int(11) NOT NULL,
  `code` varchar(20) NOT NULL COMMENT 'Ex: BRVM10, BRVMC',
  `name` varchar(100) NOT NULL,
  `description` text DEFAULT NULL,
...
CREATE TABLE `price_alerts` (
  ...
  `notification_webhook` varchar(255) DEFAULT NULL,
...
ALTER TABLE `stock_quotes`
  ...
  ADD KEY `idx_quotes_performance` (`trading_date`,`variation_percent` DESC);
...
CREATE ALGORITHM=UNDEFINED DEFINER=`brimmobi`@`localhost` SQL SECURITY DEFINER VIEW `top_losers`  AS SELECT `c`.`symbol` AS `symbol`, `c`.`name` AS `name`, `sq`.`close_price` AS `close_price`, `sq`.`variation_percent` AS `variation_percent`, `sq`.`volume` AS `volume`, `sq`.`trading_date` AS `trading_date` FROM (`stock_quotes` `sq` join `companies` `c` on(`sq`.`company_id` = `c`.`id`)) WHERE `sq`.`trading_date` = (select max(`stock_quotes`.`trading_date`) from `stock_quotes`) AND `sq`.`variation_percent` < 0 AND `c`.`active` = 1 ORDER BY `sq`.`variation_percent` ASC LIMIT 0, 10 ;
