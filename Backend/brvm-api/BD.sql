...
-- ============================================================
-- Migration 022 : moteur de liquidité & carnet d'ordres
-- (voir migrations/022_order_book_liquidity.sql et TODO_CARNET_ORDRES.md)
-- NOTE : BD.sql n'a pas été synchronisé pour les migrations 012 à 021
-- (dette préexistante) — sur base vierge, exécuter aussi ces fichiers.
-- ============================================================
