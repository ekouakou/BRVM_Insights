    ...
    <div className="flex flex-col gap-6">
      ...
      <Card>
        <div className="flex flex-wrap items-end gap-4">
          ...
          <Button
            onClick={() => reportId && analyzeMutation.mutate({ targetReportId: reportId, forceRefresh: false })}
          ...
          <Button
            variant="secondary"
            onClick={() => reportId && analyzeMutation.mutate({ targetReportId: reportId, forceRefresh: true })}
            disabled={!reportId || analyzeMutation.isPending}
          >
      ...
      {result && result.status === 'failed' && <ErrorState message={result.error_message ?? 'Échec de l’analyse'} />}
